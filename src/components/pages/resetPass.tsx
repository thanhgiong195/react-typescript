      ...
      <form>
        <div className="form-group text-left mt-2">
          <label htmlFor="exampleInputEmail1">
            Old Password
            <input type="password" className="form-control" id="oldpass" placeholder="Old Pass" />
          </label>
        </div>
        ...
        <div className="form-group text-left">
          <label htmlFor="exampleInputPassword1">
            ...
            <input type="password" className="form-control" id="newpassconfirm" placeholder="New Password Confirm" />
          </label>
        </div>
